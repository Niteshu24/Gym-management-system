...
public class SaveUserTest { // Changed class name to SaveUserTest
    ...
    public void testSaveUser() {
        // Arrange
        User user = new User("Nitesh", "nitesh@example.com", "password123");
        ...
        assertEquals("nitesh@example.com", savedUser.getEmail()); // Verify user email
        assertEquals("Nitesh", savedUser.getName()); // Verify user name
