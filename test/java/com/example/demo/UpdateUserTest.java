...
public class UpdateUserTest {
    ...
    public void testUpdateUser_UserFound() {
        // Arrange
        String oldEmail = "nitesh@example.com";
        String newName = "nitesh Updated";
        String newEmail = "nitesh.updated@example.com";
        ...
        // Act
        String viewName = HelloWorldController.updateUser(oldEmail, newName, newEmail, newMembershipId,
                model); // Call the method
    ...
    public void testUpdateUser_UserNotFound() {
        // Arrange
        String oldEmail = "nitesh@example.com";
        String newName = "New nitesh";
        String newEmail = "nitesh.email@example.com";
        ...
        // Act
        String viewName = helloWorldController.updateUser(oldEmail, newName, newEmail, newRoleId, newMembershipId,
                model); // Call the method
