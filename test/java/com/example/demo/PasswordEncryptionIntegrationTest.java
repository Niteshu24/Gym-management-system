...
public class PasswordEncryptionIntegrationTest {
    ...
    public void testPasswordEncryption() throws Exception {
        ...
        String email = "nitesh.maharzan@gmail.com"; // Ensure this email is unique

        mockMvc.perform(post("/register")
                .param("name", "Nitesh Maharjan")
                .param("email", email)
        ...
        // Step 4: Verify that the stored password matches the original when using
        // PasswordEncoder
