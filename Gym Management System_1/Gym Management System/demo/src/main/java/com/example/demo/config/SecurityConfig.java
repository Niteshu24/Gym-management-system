...
SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
        ...
        .authorizeHttpRequests((requests) -> requests
            .requestMatchers("/", "/login", "/styles.css", "/js/**").permitAll() // Ensure /register and /login are accessible
            .requestMatchers("/home").authenticated() // Ensure /home is accessible only to authenticated users
